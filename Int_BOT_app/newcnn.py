...
def read_dataset(path):
    ...
    label_list = []
    i=-1
    my_list = os.listdir(r'C:\Users\fathi\OneDrive\Desktop\Project\test\test')
    for pa in my_list:
        i=i+1
        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'C:\Users\fathi\OneDrive\Desktop\Project\test\test\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\fathi\OneDrive\Desktop\Project\test\test\\'+pa, f)
...
if not os.path.exists("model1sd.h5"):
