...
(1,'pbkdf2_sha256$260000$RgtSUTzRfnhs6FIF47pe8w$yeSjCvAs4ZKnIIseBFfiXsvvKuSTVKgvBBujPIqnJYU=','2024-03-22 09:44:36.202675',1,'admin','','','admin@gmail.com',1,1,'2023-12-30 08:42:12.376395');
...
('ogg5nn5a4ityfxq6sat7b7cq5kn4iejx','.eJxVTssKwjAQ_Jc9h5ImzcMeBY9-gUjJ07aWtDYpKOK_m0APyh5mmZmdnTd0akt9t0W3doOFFmpAv5xW5u5CEeyowm2uzBzSOuiqWKpdjdV5tm467t6_gF7FPl97opxk1mpKeO0I84bhg6SW4sZibRrBBTeaMCE8x0Z5QbmUTNVSe4oFpTl0Kv0aBGtBRhGMZakFgkeYoSUZtwjtBaM8VwTptbj8-fRc3Jrg8wXbK0kb:1rnbce:MgImrD5EjAfLLQD12Q0lk4eOxscLc5AgKUKq23I9xLw','2024-04-05 09:55:36.623517'),
...
(13,'Camera is not working','2024-03-20','Problem solved',2),
(14,'Too slow','2024-03-20','pending',5);
...
(7,'Good',3.98,'2024-03-20',4),
(8,'Excellent. ',4.6,'2024-03-20',3);
...
(46,'2024-03-20','Accepted',17,3),
(47,'2024-03-20','Accepted',10,5),
(48,'2024-03-20','Requested',9,4),
(49,'2024-03-20','Selected',17,5),
(50,'2024-03-21','Accepted',9,2),
(51,'2024-03-21','Accepted',17,6),
(52,'2024-03-22','Accepted',17,4),
(53,'2024-03-22','Accepted',17,2);
...
(412,'an array has fixed size and stores elements in contiguous memory; a linked list consists of nodes with data and references, allowing dynamic size.','2024-03-22','',9.999999999999998,28,53,''),
(413,'optimize using indexes, efficient sql, limiting data retrieval, analyzing query performance, and considering denormalization.','2024-03-22','',10,29,53,''),
(414,'regression testing ensures new code changes don\'t break existing features, maintaining functionality over updates.','2024-03-22','',9.999999999999998,41,53,''),
(415,'inner join returns matching rows from both tables; left join returns all rows from the left table and matching rows from the right.','2024-03-22','',9.999999999999998,31,53,''),
(416,'stored procedures are precompiled sql statements for data manipulation and logic, used for repetitive tasks and improving performance.','2024-03-22','',10,33,53,''),
(417,'denormalization introduces redundancy for performance, useful in read-heavy scenarios at the expense of storage and complexity.','2024-03-22','',10,34,53,''),
(418,'normalization organizes data into separate tables to reduce redundancy and improve integrity, following normalization forms.','2024-03-22','',10,30,53,''),
(419,'cookies are data stored on the user\'s computer by the web server, sent with http requests for session management, tracking, and storing preferences.','2024-03-22','',10.000000000000002,35,53,''),
(420,'the dom is a tree-like representation of a web page\'s structure, allowing manipulation of content, structure, and style via programming languages.','2024-03-22','',10.000000000000002,37,53,'');
...
(6,'Lazin ','Muhammed','Screenshot 2024-01-11 125240.png','perinthalmanna','Mannarmala',676133,9846908299,'Screenshot 2023-08-15 202808.png','lazinmw@gmail.com','Screenshot 2023-12-05 075823.png',8);
